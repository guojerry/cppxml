 ...
 *
 * $Id: //depot/code/org.antlr/main/main/lib/cpp/src/Parser.cpp#4 $
 */
 ...
 * to provide extra output in stderr in reportError for recognitionExceptions
 * to guarantee display in DOS window
 *
