...
/* $ANTLR 2.7.7 (20060906): "CPP_parser.g" -> "CPPParser.hpp"$ */
...
public:
	...
	public: void declaration_specifiers();
	public: void function_declarator(
		int definition
	);
	public: void declaration();
	public: CPPParser::TypeSpecifier  class_specifier();
	public: void class_decl_or_def(
		FunctionSpecifier fs
	);
	public: void template_head();
	public: CPPParser::FunctionSpecifier  function_specifier();
	public: void dtor_head(
		int definition
	);
	public: void dtor_definition();
	public: void ctor_decl_spec();
	public: void ctor_definition();
	public: data  scope_override();
	public: void conversion_function_decl_or_def();
	public: void function_definition();
	public: void namespace_definition();
	public: void namespace_alias_definition();
	public: data  qualified_id();
	public: void member_declaration();
	public: void ctor_declarator(
		int definition
	);
	public: void dtor_body();
	public: void compound_statement();
	public: void class_head();
	public: void access_specifier();
	...
	public: void base_clause();
	public: CPPParser::StorageClass  storage_class_specifier();
	public: CPPParser::TypeQualifier  type_qualifier();
	public: CPPParser::TypeSpecifier  type_specifier();
	public: CPPParser::TypeSpecifier  simple_type_specifier();
	public: data  qualified_type();
	...
	public: data  optor();
	public: void id_expression();
	public: void typeID();
	public: void declarator();
	public: void initializer();
	public: void expression_list();
	public: void remainder_expression();
	public: void ptr_operator();
	public: void direct_declarator();
	public: void parameter_list();
	public: void exception_specification();
	public: void declarator_suffix();
	public: void template_parameter_list();
	public: void function_direct_declarator(
		int definition
	);
	public: void ctor_head();
	public: void ctor_body();
	public: data  qualified_ctor_id();
	public: void ctor_initializer();
	public: void superclass_init();
	public: void dtor_decl_spec();
	public: void dtor_declarator(
		int definition
	);
	...
	public: void ptr_to_member();
	public: void optor_simple_tokclass();
public:
...
private:
	...
	static const ANTLR_USE_NAMESPACE(antlr)BitSet _tokenSet_145;
	static const unsigned long _tokenSet_146_data_[];
	static const ANTLR_USE_NAMESPACE(antlr)BitSet _tokenSet_146;
	static const unsigned long _tokenSet_147_data_[];
	static const ANTLR_USE_NAMESPACE(antlr)BitSet _tokenSet_147;
	static const unsigned long _tokenSet_148_data_[];
	static const ANTLR_USE_NAMESPACE(antlr)BitSet _tokenSet_148;
	static const unsigned long _tokenSet_149_data_[];
	static const ANTLR_USE_NAMESPACE(antlr)BitSet _tokenSet_149;
};
